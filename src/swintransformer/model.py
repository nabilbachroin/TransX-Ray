...
CFGS = {
    'swin_tiny_224': dict(input_size=(12, 12), window_size=7, embed_dim=96, depths=[2, 2, 6, 2], num_heads=[3, 6, 12, 24]),
    # 'swin_tiny_224': dict(input_size=(224, 224), window_size=10, embed_dim=96, depths=[2, 2, 6, 2], num_heads=[3, 6, 12, 24]),
    ...
    'swin_large_384': dict(input_size=(384, 384), window_size=12, embed_dim=192, depths=[2, 2, 18, 2], num_heads=[6, 10, 20, 1024])
}
